...
func main() {
	...
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "kubeconfig",
			Usage:  "Kubernetes kubeconfig file path",
			EnvVar: "PLUGIN_KUBECONFIG,KUBECONFIG",
		},
		cli.StringFlag{
			Name:   "token",
		...
		cli.StringFlag{
			...
			EnvVar: "PLUGIN_KUBERNETES_NAMESPACE",
		},
		cli.StringFlag{
			Name:   "template",
			Usage:  "Kubernetes template",
...
func run(c *cli.Context) error {
	...
	plugin := Plugin{
		...
		Config: Config{
			...
			KubeConfigFile: c.String("kubeconfig"),
		},
	}
